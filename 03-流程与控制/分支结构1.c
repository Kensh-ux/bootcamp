...
// 问题 6
// 一个长方形长宽分别是 9 cm、6 cm，求它的对角线长度（cm）。直接使用 cout 输出。
...
int main() {
    ...
    switch (type) {
        ...
        case 3: printf("3\n12\n2"); break;
        case 4: printf("166.667"); break;           // 6位有效数字
        case 5: printf("15"); break;
        case 6: printf("10.8167"); break;
        case 7: printf("110\n90\n0"); break;
        case 8: printf("31.4159\n78.5398\n523.599"); break;
        case 9: printf("22"); break;                // 倒推：10 -> 22
        case 10: printf("9"); break;
        case 11: printf("33.3333"); break;
        case 12: printf("13\nR"); break;
        case 13: printf("16"); break;
        case 14: printf("50"); break;               // 一元二次方程，取较小根
    }
    return 0;
}